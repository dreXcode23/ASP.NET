<%@ Page Title="Your Shopping Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="Order" %>
...
<asp:Content ID="formContent" ContentPlaceHolderID="formPlaceHolder" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString='<%$ ConnectionStrings:HalloweenConnection %>' SelectCommand="SELECT [ProductID], [Name], [ShortDescription], [LongDescription], [ImageFile], [UnitPrice] FROM [Products] ORDER BY [Name]"></asp:SqlDataSource>
    <div id="productData">   
...
<asp:Content ID="footerContent" ContentPlaceHolderID="footerPlaceHolder" runat="server">
    <label>Your Shopping Page</label>
</asp:Content>
