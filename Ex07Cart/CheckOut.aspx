    ...
    <form id="form1" runat="server" defaultfocus="txtEmail1" defaultbutton="btnCheckOut">
        ...
        <asp:TextBox ID="txtPhone" runat="server" CssClass="entry"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvPhoneNumber" runat="server" 
                ...
                Display="Dynamic" ControlToValidate="txtPhone" Text="Required"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="rfvDOB" runat="server" ErrorMessage="Date of Birth" ControlToValidate="txtDOB" Text="Required" Display="Dynamic" CssClass="validator"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="revDOB" runat="server" ErrorMessage="Date of Birth" CssClass="validator" Display="Dynamic" ControlToValidate="txtDOB" ValidationExpression="[01]?\d\/[0-3]\d\/\d{4}">Use this format: mm/dd/yyyy</asp:RegularExpressionValidator>
        ...
        <asp:RegularExpressionValidator ID="revZip" runat="server" ErrorMessage="RegularExpressionValidator" Display="Dynamic" ControlToValidate="txtZip" ValidationExpression="\d{5}(-\d{4})?" CssClass="validator">Use this format: 99999 or 99999-9999</asp:RegularExpressionValidator>
        <br />
